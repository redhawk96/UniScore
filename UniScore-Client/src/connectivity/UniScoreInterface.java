...
public interface UniScoreInterface extends Remote {
	...
	/*
	 * This interface is required to be present on both client and server. 
	 * Client will only have an interface of the implemented methods which is used to communicate with server through the proxy
	 * Business-logic / method implementations will be on the server side
	 */
