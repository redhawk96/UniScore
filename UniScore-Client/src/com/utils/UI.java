...
//	public static Color CONTENT_PANEL_BACKGROUND_COLOR = new Color(235, 240, 247);
	...
	public static int 	NAVIGATION_INDICATOR_SUB_PANEL_MAIN_LABEL_WIDTH = 81;
	public static int 	NAVIGATION_INDICATOR_SUB_PANEL_MAIN_LABEL_X_AXIS = 1004;

	public static int 	NAVIGATION_INDICATOR_SUB_PANEL_ACTIVE_LABEL_WIDTH = 105;
	public static int 	NAVIGATION_INDICATOR_SUB_PANEL_ACTIVE_LABEL_X_AXIS = 1080;
}
