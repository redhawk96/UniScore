...
public class StudentNavigationPanel extends NavigationPanel {
	...
	/*
	 * StudentNavigationPanel method : used to initialize JPanel, required properties and add UI elements to the JPanel
	 */
	public StudentNavigationPanel() {
		/*
		...
		panel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				 ...
				 * setSelectedPanel() will be called to update the already selected NavigationPanel with current selected NavigationPanel along with relevant ContentPanel
				 */
		...
		JLabel navigationLabel = new JLabel("STUDENTS");
		...
		navigationIcon.setIcon(new ImageIcon(LecturerPanel.class.getResource("/resources/students_icon.png")));
