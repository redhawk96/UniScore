...
public class SettingsNavigationPanel extends NavigationPanel {
	...
	public SettingsNavigationPanel() {
		...
		panel.setBounds(0, 497, UI.NAVIGATION_PANEL_BUTTON_WIDTH, UI.NAVIGATION_PANEL_BUTTON_HEIGHT);
		...
		panel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				 ...
				 */
				LecturerPanel.selectedNavigation = new SettingsNavigationPanel();
				LecturerPanel.selectedContent = new SettingsContentPanel();
		 ...
		 */
		JLabel navigationLabel = new JLabel("SETTINGS");
		...
		navigationIcon.setIcon(new ImageIcon(LecturerPanel.class.getResource("/resources/settings_icon.png")));
