...
public class ModulesNavigationPanel extends NavigationPanel {
	...
	public ModulesNavigationPanel () {
		...
		navigationIcon.setIcon(new ImageIcon(AdminPanel.class.getResource("/resources/modules_icon.png")));
