...
public class DashboardContentPanel extends ContentPanel {
	...
	public void displayNavigationIndicator() {
		...
		navigationIndicatorPanel.setBounds(30, 11, 1080, 36);
		...
		navigationIndicatorMainLabel.setBounds(950, UI.NAVIGATION_INDICATOR_PANEL_Y_AXIS, 71, UI.NAVIGATION_INDICATOR_PANEL_HEIGHT);
		...
		navigationIndicatorActiveLabel.setBounds(1020, UI.NAVIGATION_INDICATOR_PANEL_Y_AXIS, 50, UI.NAVIGATION_INDICATOR_PANEL_HEIGHT);
	...
	private void displayCards() {
		...
		moduleCard.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				 ...
				 */
//				AdminPanel.selectedNavigation = new ExamNavigationPanel();
//				AdminPanel.selectedContent = new ExamContentPanel();
//				AdminPanel.setSelectedPanel();
		...
		moduleCardStatNumber.setBounds(160, 0, UI.CARD_LABEL_NUMBER_WIDTH, UI.CARD_HEIGHT);
...
//				AdminPanel.setSelectedPanel();
		...
		studentCard.setBounds(303, 66, UI.CARD_WIDTH, UI.CARD_HEIGHT);
		...
		studentCardStatNumber.setBounds(160, 0, UI.CARD_LABEL_NUMBER_WIDTH, UI.CARD_HEIGHT);
...
//				AdminPanel.setSelectedPanel();
		...
		examCard.setBounds(603, 66, UI.CARD_WIDTH, UI.CARD_HEIGHT);
		...
		examCardStatNumber.setBounds(160, 0, UI.CARD_LABEL_NUMBER_WIDTH, UI.CARD_HEIGHT);
		...
		moduleCard_3.setBounds(880, 66, UI.CARD_WIDTH, UI.CARD_HEIGHT);
		...
		moduleCardStatNumber_3.setBounds(160, 0, UI.CARD_LABEL_NUMBER_WIDTH, UI.CARD_HEIGHT);
